...
def seed_notes():
    note1_notebook1_user1 = Note(notebook_id = 1, title='Test1', content="Test text1", img_url="https://st.depositphotos.com/2274151/4841/i/450/depositphotos_48410095-stock-photo-sample-blue-square-grungy-stamp.jpg")
    note2_notebook1_user1 = Note(notebook_id = 1, tags=[tag1_user1, tag2_user1])
    note1_notebook2_user1 = Note(notebook_id = 2, title='Test2', content="Test text2", tags=[tag1_user1])
    note1_notebook1_user2 = Note(notebook_id = 3, title='Test3', tags=[tag1_user2])
    note1_notebook2_user2 = Note(notebook_id = 4, title='Test4')
    note1_notebook1_user3 = Note(notebook_id = 5, title='Test5', content="Test text3", tags=[tag1_user3])
