...
def seed_notebooks():
    ...
    notebook6_user1 = Notebook(user_id = 1, title='My Furry Friends')
    ...
    notebooks = [notebook1_user1, notebook2_user1,notebook3_user1, notebook4_user1, notebook5_user1,  notebook6_user1, notebook1_user2, notebook2_user2, notebook1_user3]
